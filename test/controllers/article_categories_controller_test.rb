...
class ArticleCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create article_category" do
    assert_difference('ArticleCategory.count') do
      post :create, article_category: { article_category_id: @article_category.article_category_id, description: @article_category.description, title: @article_category.title, visible: @article_category.visible, weight: @article_category.weight }
    end
  ...
  test "should update article_category" do
    patch :update, id: @article_category, article_category: { article_category_id: @article_category.article_category_id, description: @article_category.description, title: @article_category.title, visible: @article_category.visible, weight: @article_category.weight }
    assert_redirected_to article_category_path(assigns(:article_category))
  end
