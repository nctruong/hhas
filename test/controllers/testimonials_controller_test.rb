...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { content: @testimonial.content, name: @testimonial.name, title: @testimonial.title, visible: @testimonial.visible }
    end
  ...
  test "should update testimonial" do
    patch :update, id: @testimonial, testimonial: { content: @testimonial.content, name: @testimonial.name, title: @testimonial.title, visible: @testimonial.visible }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
